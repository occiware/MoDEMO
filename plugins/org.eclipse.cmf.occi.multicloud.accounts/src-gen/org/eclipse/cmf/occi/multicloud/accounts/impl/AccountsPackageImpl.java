...
public class AccountsPackageImpl extends EPackageImpl implements AccountsPackage {
	...
	public static AccountsPackage init() {
		...
		Object registeredAccountsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		AccountsPackageImpl theAccountsPackage = registeredAccountsPackage instanceof AccountsPackageImpl ? (AccountsPackageImpl)registeredAccountsPackage : new AccountsPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEAttribute(getBasiccredential_Username(), ecorePackage.getEString(), "username", null, 0, 1, Basiccredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBasiccredential_Password(), ecorePackage.getEString(), "password", null, 0, 1, Basiccredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBasiccredential_Url(), ecorePackage.getEString(), "url", null, 0, 1, Basiccredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCertificatecredential_PublicCertificateContent(), ecorePackage.getEString(), "publicCertificateContent", null, 0, 1, Certificatecredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCertificatecredential_PrivateCertifcateName(), ecorePackage.getEString(), "privateCertifcateName", null, 0, 1, Certificatecredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getKeypaircredential_PrivateKey(), ecorePackage.getEString(), "privateKey", null, 0, 1, Keypaircredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getKeypaircredential_PublicKey(), ecorePackage.getEString(), "publicKey", null, 0, 1, Keypaircredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCloudcredential_AccessKey(), ecorePackage.getEString(), "accessKey", null, 0, 1, Cloudcredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCloudcredential_SecretKey(), ecorePackage.getEString(), "secretKey", null, 0, 1, Cloudcredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCloudcredential_Url(), ecorePackage.getEString(), "url", null, 0, 1, Cloudcredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
