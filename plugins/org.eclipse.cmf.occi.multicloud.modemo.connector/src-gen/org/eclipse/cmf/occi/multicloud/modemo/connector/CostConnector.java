 ...
 * - title: 
 */
public class CostConnector extends org.eclipse.cmf.occi.multicloud.modemo.impl.CostImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(CostConnector.class);

	// Start of user code Costconnector_constructor
	/**
	 * Constructs a cost connector.
	 */
	CostConnector()
	{
