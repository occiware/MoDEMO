 ...
 * - title: 
 */
public class CreationConnector extends org.eclipse.cmf.occi.multicloud.modemo.impl.CreationImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(CreationConnector.class);

	// Start of user code Creationconnector_constructor
	/**
	 * Constructs a creation connector.
	 */
	CreationConnector()
	{
