 ...
 * - title: 
 */
public class LoadvolumeConnector extends org.eclipse.cmf.occi.multicloud.modemo.impl.LoadvolumeImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(LoadvolumeConnector.class);

	// Start of user code Loadvolumeconnector_constructor
	/**
	 * Constructs a loadvolume connector.
	 */
	LoadvolumeConnector()
	{
