 ...
 * - title: 
 */
public class MetricConnector extends org.eclipse.cmf.occi.multicloud.modemo.impl.MetricImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(MetricConnector.class);

	// Start of user code Metricconnector_constructor
	/**
	 * Constructs a metric connector.
	 */
	MetricConnector()
	{
