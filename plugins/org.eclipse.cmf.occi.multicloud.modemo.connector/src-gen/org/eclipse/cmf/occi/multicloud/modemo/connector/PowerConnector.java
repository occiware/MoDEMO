 ...
 * - title: 
 */
public class PowerConnector extends org.eclipse.cmf.occi.multicloud.modemo.impl.PowerImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(PowerConnector.class);

	// Start of user code Powerconnector_constructor
	/**
	 * Constructs a power connector.
	 */
	PowerConnector()
	{
