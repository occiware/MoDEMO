 ...
 * - title: 
 */
public class RoundrobinConnector extends org.eclipse.cmf.occi.multicloud.modemo.impl.RoundrobinImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(RoundrobinConnector.class);

	// Start of user code Roundrobinconnector_constructor
	/**
	 * Constructs a roundrobin connector.
	 */
	RoundrobinConnector()
	{
