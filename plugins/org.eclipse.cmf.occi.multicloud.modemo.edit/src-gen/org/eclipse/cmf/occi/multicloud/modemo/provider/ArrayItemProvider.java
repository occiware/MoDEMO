...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.modemo.Array} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Array_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Array_values_feature", "_UI_Array_type"),
				 ModemoPackage.Literals.ARRAY__VALUES,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Array.class)) {
			case ModemoPackage.ARRAY__VALUES:
