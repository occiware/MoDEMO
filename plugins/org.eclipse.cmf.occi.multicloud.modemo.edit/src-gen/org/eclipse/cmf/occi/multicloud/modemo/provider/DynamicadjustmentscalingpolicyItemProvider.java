...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.modemo.Dynamicadjustmentscalingpolicy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DynamicadjustmentscalingpolicyItemProvider extends DynamicscalingpolicyItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModemoPackage.Literals.DYNAMICADJUSTMENTSCALINGPOLICY__DYNAMICADJUSTMENTSCALINGPOLICY_METRIC,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModemoPackage.Literals.DYNAMICADJUSTMENTSCALINGPOLICY__DYNAMICADJUSTMENTSCALINGPOLICY_DISABLE_SCALE_IN,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModemoPackage.Literals.DYNAMICADJUSTMENTSCALINGPOLICY__DYNAMICADJUSTMENTSCALINGPOLICY_TARGET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Dynamicadjustmentscalingpolicy dynamicadjustmentscalingpolicy = (Dynamicadjustmentscalingpolicy)object;
		return getString("_UI_Dynamicadjustmentscalingpolicy_type") + " " + dynamicadjustmentscalingpolicy.getDynamicscalingpolicyCoolDuration();
	}
