...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.modemo.Dynamicscalingpolicy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DynamicscalingpolicyItemProvider extends ScalingpolicyItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModemoPackage.Literals.DYNAMICSCALINGPOLICY__DYNAMICSCALINGPOLICY_COOL_DURATION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModemoPackage.Literals.DYNAMICSCALINGPOLICY__DYNAMICSCALINGPOLICY_ITERATION_WAIT_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Dynamicscalingpolicy dynamicscalingpolicy = (Dynamicscalingpolicy)object;
		return getString("_UI_Dynamicscalingpolicy_type") + " " + dynamicscalingpolicy.getDynamicscalingpolicyCoolDuration();
	}
