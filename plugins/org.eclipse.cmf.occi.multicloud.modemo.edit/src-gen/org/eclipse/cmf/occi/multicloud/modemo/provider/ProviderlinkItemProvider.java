...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.multicloud.modemo.Providerlink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProviderlinkItemProvider extends LinkItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ProviderlinkItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Providerlink"));
	}
	...
	public String getText(Object object) {
		String label = ((Providerlink)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Providerlink_type") :
			getString("_UI_Providerlink_type") + " " + label;
	}
