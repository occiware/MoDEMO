 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.ActiontriggerImpl#getActiontriggerAction <em>Actiontrigger Action</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.ActiontriggerImpl#getActiontriggerActionType <em>Actiontrigger Action Type</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.ActiontriggerImpl#getActiontriggerAmount <em>Actiontrigger Amount</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActiontriggerImpl extends ResourceImpl implements Actiontrigger {
	...
	protected EClass eStaticClass() {
		return ModemoPackage.Literals.ACTIONTRIGGER;
	}
	...
	public void setActiontriggerAction(ActionOperation newActiontriggerAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.ACTIONTRIGGER__ACTIONTRIGGER_ACTION, oldActiontriggerAction, actiontriggerAction));
	}
	...
	public void setActiontriggerActionType(ActionType newActiontriggerActionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.ACTIONTRIGGER__ACTIONTRIGGER_ACTION_TYPE, oldActiontriggerActionType, actiontriggerActionType));
	}
	...
	public void setActiontriggerAmount(Float newActiontriggerAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.ACTIONTRIGGER__ACTIONTRIGGER_AMOUNT, oldActiontriggerAmount, actiontriggerAmount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModemoPackage.ACTIONTRIGGER__ACTIONTRIGGER_ACTION:
				return getActiontriggerAction();
			case ModemoPackage.ACTIONTRIGGER__ACTIONTRIGGER_ACTION_TYPE:
				return getActiontriggerActionType();
			case ModemoPackage.ACTIONTRIGGER__ACTIONTRIGGER_AMOUNT:
