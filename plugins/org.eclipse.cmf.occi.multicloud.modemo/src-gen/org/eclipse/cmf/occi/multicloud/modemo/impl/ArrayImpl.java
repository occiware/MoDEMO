 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.ArrayImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayImpl extends EObjectImpl implements Array {
	...
	protected EClass eStaticClass() {
		return ModemoPackage.Literals.ARRAY;
	}
	...
	public EList<Integer> getValues() {
		if (values == null) {
			values = new EDataTypeEList<Integer>(Integer.class, this, ModemoPackage.ARRAY__VALUES);
		}
		return values;
	}
