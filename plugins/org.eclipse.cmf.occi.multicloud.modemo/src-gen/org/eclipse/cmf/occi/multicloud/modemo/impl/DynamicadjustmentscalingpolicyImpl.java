 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.DynamicadjustmentscalingpolicyImpl#getDynamicadjustmentscalingpolicyMetric <em>Dynamicadjustmentscalingpolicy Metric</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.DynamicadjustmentscalingpolicyImpl#isDynamicadjustmentscalingpolicyDisableScaleIn <em>Dynamicadjustmentscalingpolicy Disable Scale In</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.DynamicadjustmentscalingpolicyImpl#getDynamicadjustmentscalingpolicyTarget <em>Dynamicadjustmentscalingpolicy Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DynamicadjustmentscalingpolicyImpl extends DynamicscalingpolicyImpl implements Dynamicadjustmentscalingpolicy {
	...
	protected EClass eStaticClass() {
		return ModemoPackage.Literals.DYNAMICADJUSTMENTSCALINGPOLICY;
	}
	...
	public void setDynamicadjustmentscalingpolicyMetric(MetricTargetTracking newDynamicadjustmentscalingpolicyMetric) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.DYNAMICADJUSTMENTSCALINGPOLICY__DYNAMICADJUSTMENTSCALINGPOLICY_METRIC, oldDynamicadjustmentscalingpolicyMetric, dynamicadjustmentscalingpolicyMetric));
	}
	...
	public void setDynamicadjustmentscalingpolicyDisableScaleIn(boolean newDynamicadjustmentscalingpolicyDisableScaleIn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.DYNAMICADJUSTMENTSCALINGPOLICY__DYNAMICADJUSTMENTSCALINGPOLICY_DISABLE_SCALE_IN, oldDynamicadjustmentscalingpolicyDisableScaleIn, dynamicadjustmentscalingpolicyDisableScaleIn));
	}
	...
	public void setDynamicadjustmentscalingpolicyTarget(Float newDynamicadjustmentscalingpolicyTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.DYNAMICADJUSTMENTSCALINGPOLICY__DYNAMICADJUSTMENTSCALINGPOLICY_TARGET, oldDynamicadjustmentscalingpolicyTarget, dynamicadjustmentscalingpolicyTarget));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModemoPackage.DYNAMICADJUSTMENTSCALINGPOLICY__DYNAMICADJUSTMENTSCALINGPOLICY_METRIC:
				return getDynamicadjustmentscalingpolicyMetric();
			case ModemoPackage.DYNAMICADJUSTMENTSCALINGPOLICY__DYNAMICADJUSTMENTSCALINGPOLICY_DISABLE_SCALE_IN:
				return isDynamicadjustmentscalingpolicyDisableScaleIn();
			case ModemoPackage.DYNAMICADJUSTMENTSCALINGPOLICY__DYNAMICADJUSTMENTSCALINGPOLICY_TARGET:
