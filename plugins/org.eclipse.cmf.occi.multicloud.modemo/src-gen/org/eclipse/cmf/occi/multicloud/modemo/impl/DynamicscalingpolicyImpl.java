...
public class DynamicscalingpolicyImpl extends ScalingpolicyImpl implements Dynamicscalingpolicy {
	 ...
	 * @ordered
	 */
	protected static final int DYNAMICSCALINGPOLICY_COOL_DURATION_EDEFAULT = 0;
	 ...
	 * @ordered
	 */
	protected int dynamicscalingpolicyCoolDuration = DYNAMICSCALINGPOLICY_COOL_DURATION_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final int DYNAMICSCALINGPOLICY_ITERATION_WAIT_TIME_EDEFAULT = 0;
	 ...
	 * @ordered
	 */
	protected int dynamicscalingpolicyIterationWaitTime = DYNAMICSCALINGPOLICY_ITERATION_WAIT_TIME_EDEFAULT;
	 ...
	 * @generated
	 */
	public int getDynamicscalingpolicyCoolDuration() {
	 ...
	 * @generated
	 */
	public void setDynamicscalingpolicyCoolDuration(int newDynamicscalingpolicyCoolDuration) {
		int oldDynamicscalingpolicyCoolDuration = dynamicscalingpolicyCoolDuration;
	 ...
	 * @generated
	 */
	public int getDynamicscalingpolicyIterationWaitTime() {
	 ...
	 * @generated
	 */
	public void setDynamicscalingpolicyIterationWaitTime(int newDynamicscalingpolicyIterationWaitTime) {
		int oldDynamicscalingpolicyIterationWaitTime = dynamicscalingpolicyIterationWaitTime;
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case ModemoPackage.DYNAMICSCALINGPOLICY__DYNAMICSCALINGPOLICY_COOL_DURATION:
				return dynamicscalingpolicyCoolDuration != DYNAMICSCALINGPOLICY_COOL_DURATION_EDEFAULT;
			case ModemoPackage.DYNAMICSCALINGPOLICY__DYNAMICSCALINGPOLICY_ITERATION_WAIT_TIME:
				return dynamicscalingpolicyIterationWaitTime != DYNAMICSCALINGPOLICY_ITERATION_WAIT_TIME_EDEFAULT;
		}
