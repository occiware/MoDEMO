 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.LoadbalancerImpl#getLoadbalancerName <em>Loadbalancer Name</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.LoadbalancerImpl#getLoadbalancerInstanceIP <em>Loadbalancer Instance IP</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.LoadbalancerImpl#getLoadbalancerAddress <em>Loadbalancer Address</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoadbalancerImpl extends ResourceImpl implements Loadbalancer {
	...
	protected EClass eStaticClass() {
		return ModemoPackage.Literals.LOADBALANCER;
	}
	...
	public void setLoadbalancerName(String newLoadbalancerName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.LOADBALANCER__LOADBALANCER_NAME, oldLoadbalancerName, loadbalancerName));
	}
	...
	public void setLoadbalancerInstanceIP(String newLoadbalancerInstanceIP) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.LOADBALANCER__LOADBALANCER_INSTANCE_IP, oldLoadbalancerInstanceIP, loadbalancerInstanceIP));
	}
	...
	public void setLoadbalancerAddress(String newLoadbalancerAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.LOADBALANCER__LOADBALANCER_ADDRESS, oldLoadbalancerAddress, loadbalancerAddress));
	}
	...
	public void addbackendserver() {
		throw new UnsupportedOperationException();  // FIXME Unimplemented http://org.eclipse.cmf.occi.multicloud.modemo/ecore!Loadbalancer!addbackendserver()
	}
	...
	public void removebackendserver() {
		throw new UnsupportedOperationException();  // FIXME Unimplemented http://org.eclipse.cmf.occi.multicloud.modemo/ecore!Loadbalancer!removebackendserver()
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModemoPackage.LOADBALANCER__LOADBALANCER_NAME:
				return getLoadbalancerName();
			case ModemoPackage.LOADBALANCER__LOADBALANCER_INSTANCE_IP:
				return getLoadbalancerInstanceIP();
			case ModemoPackage.LOADBALANCER__LOADBALANCER_ADDRESS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ModemoPackage.LOADBALANCER___ADDBACKENDSERVER:
				addbackendserver();
				return null;
			case ModemoPackage.LOADBALANCER___REMOVEBACKENDSERVER:
				removebackendserver();
				return null;
		}
