 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.ManualscalingpolicyImpl#getManualscalingpolicyDesiredSize <em>Manualscalingpolicy Desired Size</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.ManualscalingpolicyImpl#getManualscalingpolicyComputeUnit <em>Manualscalingpolicy Compute Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ManualscalingpolicyImpl extends ScalingpolicyImpl implements Manualscalingpolicy {
	...
	protected EClass eStaticClass() {
		return ModemoPackage.Literals.MANUALSCALINGPOLICY;
	}
	...
	public void setManualscalingpolicyDesiredSize(Float newManualscalingpolicyDesiredSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.MANUALSCALINGPOLICY__MANUALSCALINGPOLICY_DESIRED_SIZE, oldManualscalingpolicyDesiredSize, manualscalingpolicyDesiredSize));
	}
	...
	public void setManualscalingpolicyComputeUnit(String newManualscalingpolicyComputeUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.MANUALSCALINGPOLICY__MANUALSCALINGPOLICY_COMPUTE_UNIT, oldManualscalingpolicyComputeUnit, manualscalingpolicyComputeUnit));
	}
