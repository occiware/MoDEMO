 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.RecurringschedulingpolicyImpl#getRecurringschedulingpolicyRecurrence <em>Recurringschedulingpolicy Recurrence</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.RecurringschedulingpolicyImpl#getRecurringschedulingpolicyStartDate <em>Recurringschedulingpolicy Start Date</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.RecurringschedulingpolicyImpl#getRecurringschedulingpolicyEndDate <em>Recurringschedulingpolicy End Date</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.RecurringschedulingpolicyImpl#getRecurringschedulingpolicyInterval <em>Recurringschedulingpolicy Interval</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RecurringschedulingpolicyImpl extends SchedulingpolicyImpl implements Recurringschedulingpolicy {
	 ...
	 * @ordered
	 */
	protected static final int RECURRINGSCHEDULINGPOLICY_INTERVAL_EDEFAULT = 0;
	 ...
	 * @ordered
	 */
	protected int recurringschedulingpolicyInterval = RECURRINGSCHEDULINGPOLICY_INTERVAL_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return ModemoPackage.Literals.RECURRINGSCHEDULINGPOLICY;
	}
	...
	public NotificationChain basicSetRecurringschedulingpolicyRecurrence(ArrofRecStep newRecurringschedulingpolicyRecurrence, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_RECURRENCE, oldRecurringschedulingpolicyRecurrence, newRecurringschedulingpolicyRecurrence);
	...
	public void setRecurringschedulingpolicyRecurrence(ArrofRecStep newRecurringschedulingpolicyRecurrence) {
		if (newRecurringschedulingpolicyRecurrence != recurringschedulingpolicyRecurrence) {
			...
			if (recurringschedulingpolicyRecurrence != null)
				msgs = ((InternalEObject)recurringschedulingpolicyRecurrence).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_RECURRENCE, null, msgs);
			if (newRecurringschedulingpolicyRecurrence != null)
				msgs = ((InternalEObject)newRecurringschedulingpolicyRecurrence).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_RECURRENCE, null, msgs);
			msgs = basicSetRecurringschedulingpolicyRecurrence(newRecurringschedulingpolicyRecurrence, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_RECURRENCE, newRecurringschedulingpolicyRecurrence, newRecurringschedulingpolicyRecurrence));
	}
	...
	public void setRecurringschedulingpolicyStartDate(Date newRecurringschedulingpolicyStartDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_START_DATE, oldRecurringschedulingpolicyStartDate, recurringschedulingpolicyStartDate));
	}
	...
	public void setRecurringschedulingpolicyEndDate(Date newRecurringschedulingpolicyEndDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_END_DATE, oldRecurringschedulingpolicyEndDate, recurringschedulingpolicyEndDate));
	}
	 ...
	 * @generated
	 */
	public int getRecurringschedulingpolicyInterval() {
	 ...
	 * @generated
	 */
	public void setRecurringschedulingpolicyInterval(int newRecurringschedulingpolicyInterval) {
		int oldRecurringschedulingpolicyInterval = recurringschedulingpolicyInterval;
		recurringschedulingpolicyInterval = newRecurringschedulingpolicyInterval;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_INTERVAL, oldRecurringschedulingpolicyInterval, recurringschedulingpolicyInterval));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_RECURRENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_START_DATE:
				return getRecurringschedulingpolicyStartDate();
			case ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_END_DATE:
				return getRecurringschedulingpolicyEndDate();
			case ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_INTERVAL:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ModemoPackage.RECURRINGSCHEDULINGPOLICY__RECURRINGSCHEDULINGPOLICY_INTERVAL:
				return recurringschedulingpolicyInterval != RECURRINGSCHEDULINGPOLICY_INTERVAL_EDEFAULT;
		}
