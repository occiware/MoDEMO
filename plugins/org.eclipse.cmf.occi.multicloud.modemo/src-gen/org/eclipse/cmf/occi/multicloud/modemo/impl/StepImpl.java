 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.StepImpl#getStepLowerStepBound <em>Step Lower Step Bound</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.StepImpl#getStepUpperStepBound <em>Step Upper Step Bound</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.StepImpl#getStepSize <em>Step Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StepImpl extends ResourceImpl implements Step {
	...
	protected EClass eStaticClass() {
		return ModemoPackage.Literals.STEP;
	}
	...
	public void setStepLowerStepBound(Float newStepLowerStepBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.STEP__STEP_LOWER_STEP_BOUND, oldStepLowerStepBound, stepLowerStepBound));
	}
	...
	public void setStepUpperStepBound(Float newStepUpperStepBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.STEP__STEP_UPPER_STEP_BOUND, oldStepUpperStepBound, stepUpperStepBound));
	}
	...
	public void setStepSize(Float newStepSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.STEP__STEP_SIZE, oldStepSize, stepSize));
	}
