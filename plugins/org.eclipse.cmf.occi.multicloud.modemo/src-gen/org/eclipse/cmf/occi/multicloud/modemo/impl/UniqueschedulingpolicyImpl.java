 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.UniqueschedulingpolicyImpl#getUniqueschedulingpolicyStartDate <em>Uniqueschedulingpolicy Start Date</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.multicloud.modemo.impl.UniqueschedulingpolicyImpl#getUniqueschedulingpolicyEndDate <em>Uniqueschedulingpolicy End Date</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UniqueschedulingpolicyImpl extends SchedulingpolicyImpl implements Uniqueschedulingpolicy {
	...
	protected EClass eStaticClass() {
		return ModemoPackage.Literals.UNIQUESCHEDULINGPOLICY;
	}
	...
	public void setUniqueschedulingpolicyStartDate(Date newUniqueschedulingpolicyStartDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.UNIQUESCHEDULINGPOLICY__UNIQUESCHEDULINGPOLICY_START_DATE, oldUniqueschedulingpolicyStartDate, uniqueschedulingpolicyStartDate));
	}
	...
	public void setUniqueschedulingpolicyEndDate(Date newUniqueschedulingpolicyEndDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModemoPackage.UNIQUESCHEDULINGPOLICY__UNIQUESCHEDULINGPOLICY_END_DATE, oldUniqueschedulingpolicyEndDate, uniqueschedulingpolicyEndDate));
	}
