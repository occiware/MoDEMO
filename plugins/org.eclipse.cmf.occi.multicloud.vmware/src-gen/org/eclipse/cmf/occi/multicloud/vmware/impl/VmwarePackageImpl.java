...
public class VmwarePackageImpl extends EPackageImpl implements VmwarePackage {
	 ...
	 * @generated
	 */
	private EClass vcenteraccountEClass = null;
	 ...
	 * @generated
	 */
	private EClass vcentercredentialEClass = null;
	...
	public void initializePackageContents() {
		...
		vcenteraccountEClass.getESuperTypes().add(theAccountsPackage.getCloudaccount());
		...
		vcentercredentialEClass.getESuperTypes().add(theAccountsPackage.getBasiccredential());
		vcentercredentialEClass.getESuperTypes().add(theOCCIPackage.getMixinBase());
		...
		initEAttribute(getInstancevmware_Imagename(), ecorePackage.getEString(), "imagename", null, 0, 1, Instancevmware.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInstancevmware_Markedastemplate(), ecorePackage.getEString(), "markedastemplate", null, 0, 1, Instancevmware.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInstancevmware_Gueststate(), ecorePackage.getEString(), "gueststate", null, 0, 1, Instancevmware.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInstancevmware_Guestosid(), ecorePackage.getEString(), "guestosid", null, 0, 1, Instancevmware.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInstancevmware_Vcpu(), ecorePackage.getEInt(), "vcpu", null, 0, 1, Instancevmware.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInstancevmware_InstanceId(), ecorePackage.getEString(), "instanceId", null, 0, 1, Instancevmware.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInstancevmware_GuestIpv4Address(), ecorePackage.getEString(), "guestIpv4Address", null, 0, 1, Instancevmware.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInstancevmware_GuestIpv6Address(), ecorePackage.getEString(), "guestIpv6Address", null, 0, 1, Instancevmware.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getVswitch_Nbport(), ecorePackage.getEInt(), "nbport", null, 0, 1, Vswitch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getVmwarefolders_Datacentername(), ecorePackage.getEString(), "datacentername", null, 0, 1, Vmwarefolders.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVmwarefolders_Datastorename(), ecorePackage.getEString(), "datastorename", null, 0, 1, Vmwarefolders.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVmwarefolders_Clustername(), ecorePackage.getEString(), "clustername", null, 0, 1, Vmwarefolders.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVmwarefolders_Hostsystemname(), ecorePackage.getEString(), "hostsystemname", null, 0, 1, Vmwarefolders.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOs_tpl_vmware_Datastoreisopath(), ecorePackage.getEString(), "datastoreisopath", null, 0, 1, Os_tpl_vmware.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSsh_user_data_Password(), ecorePackage.getEString(), "password", null, 0, 1, Ssh_user_data.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSsh_user_data_OcciComputeUserdataFile(), ecorePackage.getEString(), "occiComputeUserdataFile", null, 0, 1, Ssh_user_data.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSsh_user_data_User(), ecorePackage.getEString(), "user", null, 0, 1, Ssh_user_data.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
